...
**Typescript Task Management System** — Professional TypeScript-Task-Management-System - Created by Gabriel Demetrios Lafis

Total source lines: **92** across **1** files in **1** language.
...
Total de linhas de código: **92** em **1** arquivos em **1** linguagem.
